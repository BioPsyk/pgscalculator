...
function general_usage(){
 ...
 echo " ./pgscalculator.sh test|utest|etest"
 echo ""
 echo ""
 echo "options:"
 ...
 echo ""
 echo "Test modes (run as first argument):"
 echo "test  	 	 run all tests (unit tests + end-to-end tests)"
 echo "utest 	 	 run unit tests only"
 echo "etest 	 	 run end-to-end tests only"
 echo ""
